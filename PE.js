class PE extends Microplastic {
    ...
    constructor() {
        ...
        this.originalPurposeList = ["Grocery Bag", "Squeeze Bottle", "Laundry Detergent", "Cutting Board", "Garbage Bin", "Sandwich Bag", "Ready-Meal Tray", "Cooking Oil Bottles", "First Aid Blankets", "Polar Fleece"]
        this.pastOwnersList;
